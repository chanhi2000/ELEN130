...
**(c)** Draw the samples on your continuous time plot and be sure to label the indices (you can do $$a$$
and $$b$$ on the same plot, just use a different color for each)
